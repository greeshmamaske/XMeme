...
curl --location --request POST "https://xmemeappbackend.herokuapp.com/memes" --header "Content-Type: application/json" --data-raw "{\"name\": \"xyz\",\"url\": \"abc.com\",\"caption\": \"This is a meme\"}"
